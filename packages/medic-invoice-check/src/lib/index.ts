...
// issue #166): the on-device OCR pipeline, the fee-schedule parser incl. §5
// Steigerungsfaktor validation, the versioned fee tables, and the reusable scan
// + review UI. Nothing here talks to a backend or sends an image off-device.
